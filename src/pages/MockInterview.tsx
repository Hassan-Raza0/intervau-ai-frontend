...
export default function MockInterview({ onNavigate }: MockInterviewProps) {
  const questions = [
    {
      id: 1,
      category: 'Technical',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-cyan-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Practice with our intelligent interviewer and get instant feedback</p>
        </div>

        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Interview Details</h2>
