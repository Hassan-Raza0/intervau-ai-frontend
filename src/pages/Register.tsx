...
import { Mail, Lock, User as UserIcon, Video, Target, Users, TrendingUp } from 'lucide-react';
...
export default function Register({ onNavigate }: RegisterProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      onNavigate(getDefaultRoute(role));
    }, 800);
  };
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="space-y-4 text-white">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <div className="font-semibold mb-1">Personalized AI Feedback</div>
                <div className="text-blue-50 text-sm">Get detailed insights on your performance in real-time</div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <div className="text-blue-50 text-sm">Practice as many times as you need to build confidence</div>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                <div className="font-semibold mb-1">Comprehensive Analytics</div>
                <div className="text-blue-50 text-sm">Track your progress and identify areas for improvement</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-gray-50 dark:bg-gray-950">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center justify-center space-x-2 mb-8">
            ...
            <span className="text-2xl font-bold text-gray-900 dark:text-white">Intervau.AI</span>
          </div>

          <div className="mb-8">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Create an account</h2>
            <p className="text-gray-600 dark:text-gray-400">Start your journey to interview excellence.</p>
          </div>
