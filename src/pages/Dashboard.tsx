import { Video, FileText, TrendingUp, Clock, Award, Target, Play, Upload } from 'lucide-react';
...
export default function Dashboard({ onNavigate }: DashboardProps) {
  const stats = [
    { label: 'Total Interviews', value: '12', change: '+3 this week', icon: Video, color: 'from-blue-500 to-cyan-500' },
    { label: 'Average Score', value: '78%', change: '+5% from last', icon: Award, color: 'from-green-500 to-emerald-500' },
    { label: 'Hours Practiced', value: '8.5h', change: '2.5h this week', icon: Clock, color: 'from-orange-500 to-amber-500' },
    { label: 'Improvement Rate', value: '+12%', change: 'Last 30 days', icon: TrendingUp, color: 'from-purple-500 to-pink-500' },
  ];

  const recentInterviews = [
    { id: 1, position: 'Senior Frontend Developer', date: '2 days ago', score: 85, status: 'completed' },
    { id: 2, position: 'Full Stack Engineer', date: '5 days ago', score: 78, status: 'completed' },
    { id: 3, position: 'Product Manager', date: '1 week ago', score: 72, status: 'completed' },
  ];
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat) => (
          <div key={stat.label} className="bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-200 p-6 transition-all duration-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        >
            <div className="flex items-center space-x-4 mb-4">
              ...
              <div className="text-left">
                ...
                <p className="text-blue-100 text-sm">Practice with AI interviewer</p>
              </div>
            </div>
          </button>
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div className="text-left">
              <h3 className="text-xl font-bold text-gray-900 mb-1">Upload Resume</h3>
        ...
        <button className="bg-white rounded-xl p-8 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 group">
          <div className="flex items-center space-x-4">
            ...
            <div className="text-left">
              <h3 className="text-xl font-bold text-gray-900 mb-1">View Reports</h3>
              <p className="text-gray-600 text-sm">Detailed performance analytics</p>
            </div>
          </div>
        </button>
      </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-md p-6 border border-gray-200">
          ...
          <div className="space-y-3">
            {recentInterviews.map((interview) => (
              <div key={interview.id} className="flex items-center justify-between p-4 bg-gray-50 border border-gray-100 rounded-lg hover:bg-gray-100 transition-colors">
                <div className="flex items-center space-x-4">
