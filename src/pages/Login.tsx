      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-cyan-600 p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <p className="text-blue-50 text-lg mb-8">
            Continue practicing and improving your interview skills with AI-powered insights.
          </p>
          ...
          <div className="mt-12 p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
            ...
            <p className="text-blue-50 text-sm">
              Regular practice sessions improve your confidence by up to 45%. Try a mock interview today!
            </p>
          </div>
        </div>
      </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center space-x-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500 focus:ring-2" />
